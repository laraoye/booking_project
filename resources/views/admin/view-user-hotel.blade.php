...
@section('content')
    <div class="form-container">
        ...
        <form action="{{ route('hotels.update', $reservation->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="input-row">
                <div class="input-group">
                    ...
                    <input type="date" id="check_in_date" name="check_in_date" value="{{ $reservation->check_in_date }}" required>
                </div>
                <div class="input-group">
                    <label for="check_out_date">Check-out Date</label>
                    <input type="date" id="check_out_date" name="check_out_date" value="{{ $reservation->check_out_date }}" required>
                </div>
            </div>
            ...
            <div class="input-row">
                <div class="input-group">
                    ...
                    <select id="room_type" name="room_type" required>
                        <option value="Single" {{ $reservation->room_type === 'Single' ? 'selected' : '' }}>Single</option>
                        <option value="Double" {{ $reservation->room_type === 'Double' ? 'selected' : '' }}>Double</option>
                        <option value="Suite" {{ $reservation->room_type === 'Suite' ? 'selected' : '' }}>Suite</option>
                    </select>
                </div>
                <div class="input-group">
                    <label for="special_requests">Special Requests</label>
                    <input type="text" id="special_requests" name="special_requests" value="{{ $reservation->special_requests }}" placeholder="e.g. late check-in">
                </div>
            </div>
